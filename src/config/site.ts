...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Attack research. No vendor filter." },
...
export const siteConfig: SiteConfig = {
  domain: "aiattacks.dev",
  url: "https://aiattacks.dev",
  title: "AI Attacks",
  tagline: "Practitioner-grade AI red team techniques and tooling.",
  description:
  ...
  byline: "AI Attacks Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 158, cluster: "offensive" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@aiattacks.dev",
    abuse: "abuse@aiattacks.dev",
    editor: "editor@aiattacks.dev",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "aiattacks.dev"),
  analytics: {},
};
